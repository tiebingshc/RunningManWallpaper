...
public abstract class ImageWorker {
     ...
     */
    public Object loadImage(Object data, ImageView imageView) {
        Bitmap bitmap = null;
     ...
     * @param imageView The ImageView to bind the downloaded image to.
     */
    public Object loadImage(int num, ImageView imageView) {
        if (mImageWorkerAdapter != null) {
           return loadImage(mImageWorkerAdapter.getItem(num), imageView);
        } else {
